...
describe('zoneToPlacement', () => {
  it('maps top zones high and bottom zones low', () => {
    expect(zoneToPlacement('top-center').yPct).toBeLessThan(50);
    expect(zoneToPlacement('bottom-center').yPct).toBeGreaterThan(50);
  });

  it('maps left/center/right across the frame', () => {
