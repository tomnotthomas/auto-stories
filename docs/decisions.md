...
- **Decision:**
  - **README** = the Auto Stories project README (live URL, one-command Docker run, local dev + the proxy, layout, command table, docs links). The verbatim challenge prompt moves to `docs/CHALLENGE.md`.
